...
```{bash, eval = F}
# Single-end
for file in ./processed/*trimmed.fq.gz
do
...
```{bash, eval = F}
# Paired-end
for file in ./processed/*_1.fastq.gz                                                         # Read1
do
  ...
  kallisto quant --index ./kallisto_quant/transcripts.idx --output-dir ./kallisto_quant/${clean} --threads 12 ${file} ${file_2}
done
```
...
.pull-right[
```{r, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("figures/AgencyLogo.svg")
```
]
